...
module.exports = app => {
  ...
  app.post('/position/',(req,res) => {trowoo.createPosition(req,res)});
  ...
  app.post('/alert/highPrice/',(req,res) => {trowoo.createHighPrice(req,res)});
  ...
  app.post('/alert/lowPrice/', (req,res) => {trowoo.createLowPrice(req,res)});
  ...
  app.post('/alert/trailingStop/', (req,res) => {trowoo.createTrailingStop(req,res)});
